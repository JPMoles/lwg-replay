  ...
  t.widget("ui.droppable", {
    ...
    (t.ui.intersect = function (t, i, s) {
      ...
      switch (s) {
        ...
        case "touch":
          return (
            ((l >= d && p >= l) || (h >= d && p >= h) || (d > l && h > p)) &&
            ((o >= c && u >= o) || (r >= c && u >= r) || (c > o && r > u))
          );
        default:
          return !1;
      }
        ...
        : ((r = a || {}),
          ...
          l &&
            ...
            null !== u &&
              r.dateFormat !== t &&
              r.minDate === t &&
              (l.settings.minDate = this._formatDate(l, u)),
            null !== c &&
              r.dateFormat !== t &&
              r.maxDate === t &&
    ...
    parseDate: function (i, a, s) {
      ...
      if (
        (-1 === f
          ...
          : 100 > f &&
            (f +=
              new Date().getFullYear() - (new Date().getFullYear() % 100) + (h >= f ? 0 : -100)),
        k > -1)
      )
        for (_ = 1, v = k; ; ) {
        ...
        for (w = "", this.maxRows = 4, M = 0; q[1] > M; M++) {
          ...
          for (
            ...
            (T = (y + l) % 7),
              (N +=
                "<th" +
                ((y + l + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") +
                ">" +
                "<span title='" +
                d[T] +
                "'>" +
            ...
            (i = 100 * ((l.values(s) - l._valueMin()) / (l._valueMax() - l._valueMin()))),
              ...
              l.options.range === !0 &&
                ("horizontal" === l.orientation
                  ? (0 === s &&
                      l.range.stop(1, 1)[h ? "animate" : "css"](
                        {
                          left: i + "%",
                        },
                        r.animate
